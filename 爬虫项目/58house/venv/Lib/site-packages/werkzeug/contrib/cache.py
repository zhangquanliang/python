...
"""
    ...
    Here is a simple example of how to cache a sidebar for 1 minutes::
        ...
        def get_sidebar(user):
            ...
            cache.set(identifier, value, timeout=60 * 1)
            return value
...
def _items(mappingorseq):
    ...
    or sequences::
        ...
        >>> for k, v in _items((i, i*i) for i in xrange(1)):
        ...    assert k*k == v

        >>> for k, v in _items(dict((i, i*i) for i in xrange(1))):
        ...    assert k*k == v
