...
class EnvironBuilder(object):
    ...
    Werkzeug 0.1 (:func:`create_environ`, :meth:`BaseResponse.from_values`,
    ...
    :param content_type: The content type for the request.  As of 0.1 you
...
def create_environ(*args, **kwargs):
    ...
    .. versionchanged:: 0.1
       ...
       was added in 0.1.  The `headers`, `environ_base`, `environ_overrides`
