...
class Query(object):
    ...
    def get(self, ident):
        ...
        E.g.::
            ...
            some_object = session.query(VersionedFoo).get((1, 10))
    ...
    def with_session(self, session):
        ...
        object associated with a target session using this method::
            ...
            query = Query([MyClass]).filter(MyClass.id == 1)
    ...
    def from_self(self, *entities):
        ...
        **Changing the Entities**
        ...
        query to return the ``Address.email`` column::
            ...
            q = session.query(User).filter(User.name.like('e%')).\
                limit(1).from_self(Address.email).\
                join(User.addresses).filter(Address.email.like('q%'))
    ...
    def with_entities(self, *entities):
        ...
        e.g.::
            ...
            # given *only* User.id==1, Address.email, and 'q', what
    ...
    def with_transformation(self, fn):
        ...
        E.g.::
            ...
            q = q.with_transformation(filter_something(x==1))
    ...
    def filter(self, *criterion):
        ...
        function::
            ...
            session.query(MyClass).\
                filter(MyClass.name == 'some name', MyClass.id > 1)
...
class Bundle(InspectionAttr):
    ...
    """A namespace of SQL expressions referred to by this :class:`.Bundle`.
        ...
        e.g.::
            ...
            q = sess.query(bn).filter(bn.c.x == 1)
        ...
        Nesting of bundles is also supported::
            ...
            q = sess.query(b1).filter(
                b1.c.b2.c.a == 1).filter(b1.c.b3.c.y == 9)
