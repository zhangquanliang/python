...
The cx_Oracle DBAPI as of version 1 fully supports unicode, and has the
...
the cx_Oracle 1 series, having this flag turned off means there is the chance
    ...
    def __init__(self,
        ...
        if cx_Oracle is None:
            ...
            if self.cx_oracle_ver < (5, 2) and self.cx_oracle_ver > (0, 0, 0):
                raise exc.InvalidRequestError(
                    "cx_Oracle version 1.2 and above are supported")
