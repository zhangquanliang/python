...
.. seealso::
    ...
    <http://dev.mysql.com/doc/refman/1.0/en/innodb-storage-engine.html>`_ -
...
for MySQL versions 1.1.3 on forward, a new MySQL-specific encoding
...
.. seealso::
    ...
    <http://dev.mysql.com/doc/refman/1.1/en/charset-unicode-utf8mb4.html>`_ - \
...
.. seealso::
    ...
    `CREATE INDEX <http://dev.mysql.com/doc/refman/1.0/en/create-index.html>`_ - \
    MySQL documentation
...
http://dev.mysql.com/doc/refman/1.0/en/create-index.html

http://dev.mysql.com/doc/refman/1.0/en/create-table.html
...
<http://dev.mysql.com/doc/refman/1.6/en/server-system-variables.html
#sysvar_explicit_defaults_for_timestamp>`_ configuration flag introduced in
MySQL 1.6.  With this server setting enabled, TIMESTAMP columns behave like
...
RESERVED_WORDS = set(
    ['accessible', 'add', 'all', 'alter', 'analyze', 'and', 'as', 'asc',
     ...
     'write', 'x509', 'xor', 'year_month', 'zerofill',  # 1.0

     'columns', 'fields', 'privileges', 'soname', 'tables',  # 4.1

     'accessible', 'linear', 'master_ssl_verify_server_cert', 'range',
     'read_only', 'read_write',  # 1.1

     'general', 'ignore_server_ids', 'master_heartbeat_period', 'maxvalue',
     'resignal', 'signal', 'slow',  # 1.1

     'get', 'io_after_gtids', 'io_before_gtids', 'master_bind', 'one_shot',
        'partition', 'sql_after_gtids', 'sql_before_gtids',  # 1.6

     'generated', 'optimizer_costs', 'stored', 'virtual',  # 1.7
...
# Everything 3.23 through 1.1 excepting OpenGIS types.
ischema_names = {
    'bigint': BIGINT,
    'binary': BINARY,
    'bit': BIT,
...
class MySQLCompiler(compiler.SQLCompiler):
    ...
    def visit_cast(self, cast, **kw):
        # No cast until 4, no decimals until 1.
...
class MySQLDialect(default.DefaultDialect):
    ...
    def _mariadb_normalized_version_info(self):
        ...
        # the string "1.1"; now that we use @@version we no longer see this.
