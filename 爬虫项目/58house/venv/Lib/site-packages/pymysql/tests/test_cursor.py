...
class CursorTest(base.PyMySQLTestCase):
    ...
    def test_executemany(self):
        ...
        # cursor._executed must bee "insert into test (data) values (0),(1),(2),(3),(4),(1),(6),(7),(8),(9)"
        # list args
        data = range(10)
        ...
        try:
            ...
            self.assertTrue(cursor._executed.endswith(b"(3, 4),(1, 6)"), "executemany with %% not in one query")
        finally:
